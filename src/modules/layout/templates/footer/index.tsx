...
export default async function Footer() {
  ...
  return (
    <div className="container relative">
      <carousel-slider className="carousel block relative" inactive="">
        <div className="slider-nav slide-nav--inline flex justify-between absolute top-0 h-full no-js-hidden">
          <button
            type="button"
            className="slider-nav__btn tap-target tap-target--left btn text-current has-ltr-icon"
            name="prev"
            aria-controls="slider-sections--21965478625572__icons-with-text"
          >
          ...
          <button
            type="button"
            className="slider-nav__btn tap-target tap-target--right btn text-current has-ltr-icon"
            name="next"
            aria-controls="slider-sections--21965478625572__icons-with-text"
          >
        ...
        <div
          className="slider slider--contained relative slider--no-scrollbar"
          id="slider-sections--21965478625572__icons-with-text"
        >
          <ul className="slider__grid grid grid-flow-col gap-theme auto-cols-1 sm:auto-cols-2 md:auto-cols-3 lg:auto-cols-4">
            <li
              className="slider__item flex justify-center items-center cc-animate-init cc-animate-in"
              data-cc-animate=""
              data-cc-animate-delay="0.07s"
              style={{ animationDelay: "0.07s" }}
            >
              <svg
                className="icon icon--chat_bubble"
                width="36"
                height="36"
                viewBox="0 0 16 16"
                aria-hidden="true"
              ...
              <div className="icons-with-text__text rte">
                <p className="m-0 icons-with-text__title text-body-medium">
                  <strong>Visit our support center</strong>
                </p>
                <div className="rte text-body-medium">
            ...
            >
              <svg
                className="icon icon--dollar_sign"
                width="36"
                height="36"
                viewBox="0 0 16 16"
                aria-hidden="true"
              ...
              >
                ...
                <path
                  stroke="currentColor"
                  fill="none"
                  d="M 11.15031,3.6845048 H 6.4280755 a 2.2037096,2.2037096 0 0 0 0,4.4074192 h 3.1481559 a 2.2037095,2.2037095 0 0 1 0,4.407417 H 4.224366"
                ></path>
              </svg>
              <div className="icons-with-text__text rte">
                <p className="m-0 icons-with-text__title text-body-medium">
